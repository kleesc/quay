...
SECURITY_TESTS: List[
    ...
    (SuperUserRepositoryList, "GET", None, None, None, 401),
    (SuperUserRepositoryList, "GET", None, None, "devtable", 200),
    (SuperUserRepositoryList, "GET", None, None, "freshuser", 403),
    (SuperUserRepositoryList, "GET", None, None, "reader", 403),
